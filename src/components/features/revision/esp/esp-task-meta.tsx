...
/** Deep-link into a scenario + stage (preferred for sandboxes). */
export function getEspScenarioTaskHref(scenarioId: string, taskId: EspTask) {
  return `/revision/esp/${scenarioId}/${ESP_TASK_SLUGS[taskId]}`;
}
